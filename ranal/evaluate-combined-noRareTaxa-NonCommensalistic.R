...
files = list.files('../result/output_aggregated_pivoted', full.names=TRUE, pattern='*species-norareG_pivoted.csv')
print(files)
...
ggsave("fig/combined-prediction-accuracy-by-network-types-noRareTaxa-NonCommensalistic.png", height=8, width=8)
ggsave("fig/combined-prediction-accuracy-by-network-types-noRareTaxa-NonCommensalistic.pdf", height=8, width=8)
...
ggsave("fig/combined-prediction-accuracy-noRareTaxa-NonCommensalistic.png", height=8, width=8)
ggsave("fig/combined-prediction-accuracy-noRareTaxa-NonCommensalistic.pdf", height=8, width=8)
...
print(
  ...
  file = "fig/combined-results-summarize-table-noRareTaxa-NonCommensalistic.tex",
