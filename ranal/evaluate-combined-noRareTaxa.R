...
ggsave("fig/combined-prediction-accuracy-by-network-types-noRareTaxa.png", height=8, width=8)
ggsave("fig/combined-prediction-accuracy-by-network-types-noRareTaxa.pdf", height=8, width=8)
...
ggsave("fig/combined-prediction-accuracy-noRareTaxa.png", height=8, width=8)
ggsave("fig/combined-prediction-accuracy-noRareTaxa.pdf", height=8, width=8)
...
print(
  ...
  file = "fig/combined-results-summarize-table-noRareTaxa.tex",
